...
// readFloat reads a floating point value and adds it to the svgCursor's points slice.
...
// and add them to the svgCursor's points slice.
...
// addArcFromA adds a path of an arc element to the svgCursor path to the pathCursor
